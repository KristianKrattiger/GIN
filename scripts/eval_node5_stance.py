...
def main() -> int:
    ...
    print("  The NLI channel keeps priority over the stance arm by design, so an")
    print("  NLI false positive is NOT a stance-channel error. The spec measured")
    print("  that NLI's two highest p_contra in this set are a corroborates")
    print("  (0.983) and a supersedes (0.980) -- those are exactly the pairs")
    print("  showing up here, which is the predicted cost of leaving NLI first.")
