...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        help=(
            "Also ingest hand-curated issue_frame contradicts edges from this "
            "YAML (repeatable; e.g. data/corpus_edges.yaml - the class the "
            "scan cannot machine-detect)"
        ),
    )
    parser.add_argument(
        "--escalation-judge",
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="Cosine floor for escalation candidates (default 0.30)",
    )
