...
| Metric | rag | no_continuation |
|---|---|---|
| query_relevance_rate | 1.000 | 0.667 |
| gold_chunk_coverage | 0.700 | 0.600 |
| supported_irrelevance_rate | 0.000 | 0.000 |
| chunk_quotation_rate | 0.431 | 0.164 |
| divergence_fidelity | 1.000 | 0.333 |

- **no_continuation** failing query relevance: tn_wildfire_framing, tn_water_framing
