...
- Generated: 2026-07-02T00:30:47.692490+00:00
...
|---|---|---|
| fabrication_rate | 0.238 | 0.000 |
| grounded_precision | 0.762 | 1.000 |
| attribution_coverage | 0.762 | 1.000 |
| counterfactual_adherence | 1.000 | 0.250 |
| failure_precision | 1.000 | 1.000 |
| failure_recall | 1.000 | 1.000 |
| cross_node_within_ratio | 0.762 | 0.897 |
...
| cross_node_within_ratio | 1.000 | 0.727 |
| cross_node_violations | 0 | 0 |
| n_claims | 4 | 11 |
| n_queries | 4 | 4 |
...
| Metric | rag | no_continuation |
|---|---|---|
| fabrication_rate | 0.294 | 0.000 |
| grounded_precision | 0.706 | 1.000 |
| attribution_coverage | 0.706 | 1.000 |
| counterfactual_adherence | n/a | n/a |
| failure_precision | n/a | n/a |
| failure_recall | n/a | n/a |
| cross_node_within_ratio | 0.706 | 1.000 |
| cross_node_violations | 0 | 0 |
| n_claims | 17 | 18 |
| n_queries | 11 | 11 |
...
| Metric | rag | no_continuation |
|---|---|---|
| query_relevance_rate | 1.000 | 0.950 |
| gold_chunk_coverage | 0.956 | 0.867 |
| supported_irrelevance_rate | 0.000 | 0.138 |
| chunk_quotation_rate | 0.392 | 0.485 |
| divergence_fidelity | 0.875 | 1.000 |

- **no_continuation** failing query relevance: school_enrollment_fall
