...
|---|---|---|
| fabrication_rate | 0.200 | 0.000 |
| grounded_precision | 0.800 | 1.000 |
| attribution_coverage | 0.800 | 1.000 |
| counterfactual_adherence | n/a | n/a |
| failure_precision | n/a | n/a |
| failure_recall | n/a | n/a |
| cross_node_within_ratio | 0.800 | 1.000 |
...
| gold_chunk_coverage | 1.000 | 1.000 |
| supported_irrelevance_rate | 0.000 | 0.000 |
| chunk_quotation_rate | 0.833 | 0.833 |
