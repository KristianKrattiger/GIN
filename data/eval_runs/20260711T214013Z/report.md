...
- Generated: 2026-07-11T21:40:13.886502+00:00
...
- Queries: 20
- GPU layers: -1
- Wall-clock per query: 0.93s
- Tokens/s (approx): 19.4

## Overall

| Metric | rag | no_continuation |
|---|---|---|
| fabrication_rate | 0.273 | 0.000 |
| grounded_precision | 0.727 | 1.000 |
| attribution_coverage | 0.727 | 1.000 |
| counterfactual_adherence | 1.000 | 1.000 |
| failure_precision | 1.000 | 0.625 |
| failure_recall | 1.000 | 1.000 |
| cross_node_within_ratio | 0.727 | 0.733 |
...
| Metric | rag | no_continuation |
|---|---|---|
| query_relevance_rate | 1.000 | 0.850 |
| gold_chunk_coverage | 0.933 | 0.800 |
| supported_irrelevance_rate | 0.000 | 0.000 |
| chunk_quotation_rate | 0.408 | 0.317 |
| divergence_fidelity | 1.000 | 0.500 |

- **no_continuation** failing query relevance: incident_hospital, election_margin, school_enrollment_fall
