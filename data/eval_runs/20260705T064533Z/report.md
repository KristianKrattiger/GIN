...
|---|---|---|
| fabrication_rate | 0.412 | 0.000 |
| grounded_precision | 0.588 | 1.000 |
| attribution_coverage | 0.588 | 1.000 |
| counterfactual_adherence | n/a | n/a |
| failure_precision | n/a | 1.000 |
| failure_recall | 0.000 | 1.000 |
| cross_node_within_ratio | 0.588 | 1.000 |
...
| Metric | rag | no_continuation |
|---|---|---|
| fabrication_rate | 0.438 | 0.000 |
| grounded_precision | 0.562 | 1.000 |
| attribution_coverage | 0.562 | 1.000 |
| counterfactual_adherence | n/a | n/a |
| failure_precision | n/a | n/a |
| failure_recall | n/a | n/a |
| cross_node_within_ratio | 0.562 | 1.000 |
| cross_node_violations | 0 | 0 |
| n_claims | 16 | 8 |
| n_queries | 5 | 5 |
...
| chunk_quotation_rate | 0.514 | 0.314 |
