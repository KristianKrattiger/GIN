...
|---|---|---|
| fabrication_rate | 0.400 | 0.000 |
| grounded_precision | 0.600 | 1.000 |
| attribution_coverage | 0.600 | 1.000 |
| counterfactual_adherence | n/a | n/a |
| failure_precision | 1.000 | 1.000 |
| failure_recall | 1.000 | 1.000 |
| cross_node_within_ratio | 0.600 | 1.000 |
...
| gold_chunk_coverage | 0.700 | 0.700 |
| supported_irrelevance_rate | 0.000 | 0.000 |
| chunk_quotation_rate | 0.414 | 0.239 |
