...
- Generated: 2026-07-11T21:47:51.427389+00:00
...
- Queries: 6
- GPU layers: -1
- Wall-clock per query: 2.38s
- Tokens/s (approx): 22.2

## Overall

| Metric | rag | no_continuation |
|---|---|---|
| fabrication_rate | 0.429 | 0.000 |
| grounded_precision | 0.571 | 1.000 |
| attribution_coverage | 0.571 | 1.000 |
| counterfactual_adherence | n/a | n/a |
| failure_precision | n/a | 1.000 |
| failure_recall | 0.000 | 1.000 |
| cross_node_within_ratio | 0.571 | 1.000 |
...
| Metric | rag | no_continuation |
|---|---|---|
| fabrication_rate | 0.000 | n/a |
| grounded_precision | 1.000 | n/a |
| attribution_coverage | 1.000 | n/a |
| counterfactual_adherence | n/a | n/a |
| failure_precision | n/a | 1.000 |
| failure_recall | 0.000 | 1.000 |
| cross_node_within_ratio | 1.000 | n/a |
| cross_node_violations | 0 | 0 |
| n_claims | 1 | 0 |
| n_queries | 1 | 1 |
...
| Metric | rag | no_continuation |
|---|---|---|
| fabrication_rate | 0.450 | 0.000 |
| grounded_precision | 0.550 | 1.000 |
| attribution_coverage | 0.550 | 1.000 |
| counterfactual_adherence | n/a | n/a |
| failure_precision | n/a | n/a |
| failure_recall | n/a | n/a |
| cross_node_within_ratio | 0.550 | 1.000 |
| cross_node_violations | 0 | 0 |
| n_claims | 20 | 8 |
| n_queries | 5 | 5 |
...
| Metric | rag | no_continuation |
|---|---|---|
| query_relevance_rate | 0.833 | 1.000 |
| gold_chunk_coverage | 0.700 | 1.000 |
| supported_irrelevance_rate | 0.000 | 0.000 |
| chunk_quotation_rate | 0.614 | 0.314 |
| divergence_fidelity | 1.000 | 1.000 |

- **rag** failing query relevance: tn_out_of_scope_referendum
